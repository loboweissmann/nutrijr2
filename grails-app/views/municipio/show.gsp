			...
			<ol class="property-list municipio">
				...
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="municipio.nome.label" default="Nome" /></span>
						...
						<span class="property-value" aria-labelledby="nome-label">${municipioInstance.nome}</span>
				...
				<li class="fieldcontain">
					<span id="estado-label" class="property-label"><g:message code="municipio.estado.label" default="Estado" /></span>
						...
						<span class="property-value" aria-labelledby="estado-label"><g:link controller="UF" action="show" id="${municipioInstance?.estado?.id}">${municipioInstance?.estado?.encodeAsHTML()}</g:link></span>
